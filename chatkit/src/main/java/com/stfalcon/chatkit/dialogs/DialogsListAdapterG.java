...
public class DialogsListAdapterG<DIALOG extends IDialogG>
        extends RecyclerView.Adapter<DialogsListAdapterG.BaseDialogViewHolder> {
    ...
    private static ArrayList<GroupIn> listA;
     ...
     */
    public DialogsListAdapterG(ImageLoader imageLoader) {
     ...
     * @param imageLoader  image loading method
     */
    public DialogsListAdapterG(@LayoutRes int itemLayoutId, ImageLoader imageLoader) {
     ...
     * @param imageLoader  image loading method
     */
    public DialogsListAdapterG(@LayoutRes int itemLayoutId, Class<? extends BaseDialogViewHolder> holderClass,
     ...
     */
    @SuppressWarnings("unchecked")
    public boolean updateDialogWithMessage(ArrayList<GroupIn> lista,String dialogId,GroupIn user) {
        listA = new ArrayList<>();
        boolean dialogExist = false;
        for (int i = 0; i < lista.size(); i++) {
            if (lista.get(i).getId().equals(dialogId)) {
                listA = lista;
                listA.set(i,user);
                notifyItemChanged(i);
                if (i != 0) {
                    Collections.swap(listA, i, 0);
                    notifyItemMoved(i, 0);
                }
                dialogExist = true;
                break;
    ...
    public ArrayList<GroupIn> updateLocal()
    {
        return  listA;
    }
    ...
    * LISTENERS
    * */
    public interface OnDialogClickListener<DIALOG extends IDialogG> {
        void onDialogClick(DIALOG dialog);
    }

    public interface OnDialogViewClickListener<DIALOG extends IDialogG> {
        void onDialogViewClick(View view, DIALOG dialog);
    }

    public interface OnDialogLongClickListener<DIALOG extends IDialogG> {
        void onDialogLongClick(DIALOG dialog);
    }

    public interface OnDialogViewLongClickListener<DIALOG extends IDialogG> {
    ...
    * HOLDERS
    * */
    public abstract static class BaseDialogViewHolder<DIALOG extends IDialogG>
    ...
    public static class DialogViewHolder<DIALOG extends IDialogG> extends BaseDialogViewHolder<DIALOG> {
        ...
        public DialogViewHolder(View itemView) {
            ...
            tvName = (EmojiTextView) itemView.findViewById(R.id.dialogName);

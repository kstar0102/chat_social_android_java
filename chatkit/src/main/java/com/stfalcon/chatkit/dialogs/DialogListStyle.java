...
public class DialogListStyle extends Style {
    ...
    static DialogListStyle parse(Context context, AttributeSet attrs) {
        DialogListStyle style = new DialogListStyle(context,
                attrs);
        ...
        style.dialogItemBackground = typedArray.getColor(R.styleable.DialogsList_dialogItemBackground,
            ...
            style.dialogUnreadItemBackground = typedArray.getColor(R.styleable.DialogsList_dialogItemBackground,
                    style.getColor(R.color.transparent_unread));

...
public class DialogsListAdapter<DIALOG extends IDialog>
    ...
    private static ArrayList<UserIn> listA;
     ...
     */
    @SuppressWarnings("unchecked")
    public boolean updateDialogWithMessage(ArrayList<UserIn> lista,String dialogId,UserIn user) {
        listA = new ArrayList<>();
    ...
    public ArrayList<UserIn> updateLocal()
    {
        return  listA;
    }
    ...
    public int halbine(ArrayList<UserIn> ml, String id) {
            int j = 0, i = 0;
        for (i = 0; i < ml.size(); i++) {

...
public class FollowFragAdapter extends ArrayAdapter {
    ArrayList listItem = new ArrayList<>();
    public FollowFragAdapter(@NonNull Context context, int textViewResourceId, ArrayList objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        v = inflater.inflate(R.layout.item_follow_custom, null);

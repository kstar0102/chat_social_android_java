...
import com.codeslutest.plax.calls.IncAudioActivity;
import com.codeslutest.plax.calls.IncCallActivity;
    ...
    void GetMessage(Map<String, String> map) {
        ...
        if (react != null){
            ...
            if (message.contains("react//like//"))
                prefixR = getResources().getString(com.codeslutest.plax.R.string.likeR);
            else if (message.contains("react//funny//"))
                prefixR = getResources().getString(com.codeslutest.plax.R.string.funnyR);
            else if (message.contains("react//love//"))
                prefixR = getResources().getString(com.codeslutest.plax.R.string.loveR);
            else if (message.contains("react//sad//"))
                prefixR = getResources().getString(com.codeslutest.plax.R.string.sadR);
            else if (message.contains("react//angry//"))
                prefixR = getResources().getString(com.codeslutest.plax.R.string.angryR);
